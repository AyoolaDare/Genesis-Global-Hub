...
class TeamDashboardData {
  ...
  factory TeamDashboardData.fromJson(Map<String, dynamic> json) {
    return TeamDashboardData(
      ...
      completedTasksThisMonth: json['completed_tasks_this_month'] ?? 0,
...
final teamDashboardProvider = FutureProvider<TeamDashboardData>((ref) async {
  final dio = ref.read(dioProvider);
  final response = await dio.get(ApiEndpoints.teamDashboard);
  return TeamDashboardData.fromJson(response.data['data']);
});
...
class TeamDashboard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ShellLayout(
      ...
      child: RefreshIndicator(
        onRefresh: () => ref.refresh(teamDashboardProvider.future),
        child: SingleChildScrollView(
          padding: const EdgeInsets.all(24),
          child: ref.watch(teamDashboardProvider).when(
                loading: () => Column(
                  children: [
                    GridView.count(
                      crossAxisCount: 2,
                ...
                error: (e, _) => ErrorState(
                  ...
                  onRetry: () => ref.invalidate(teamDashboardProvider),
                ),
  ...
  Widget _buildContent(BuildContext context, TeamDashboardData data) {
    return Column(
  ...
  Widget _buildStatsGrid(BuildContext context, TeamDashboardData data) {
