...
// ---------------------------------------------------------------------------
// Provider (scoped to dept)
// ---------------------------------------------------------------------------

final deptMembersProvider =
...
class DeptMembersScreen extends ConsumerStatefulWidget {
  const DeptMembersScreen({super.key});

  @override
  ConsumerState<DeptMembersScreen> createState() =>
      _DeptMembersScreenState();
}

class _DeptMembersScreenState extends ConsumerState<DeptMembersScreen> {
  int _page = 1;
  String _search = '';
  ...
  Widget build(BuildContext context) {
    final membersAsync = ref.watch(deptMembersProvider(_params));
          ...
          Expanded(
            child: membersAsync.when(
              ...
              error: (e, _) => ErrorState(
                ...
                onRetry: () =>
                    ref.invalidate(deptMembersProvider(_params)),
              ),
              data: (members) => members.items.isEmpty
                  ? EmptyState(
                      ...
                      subtitle: _search.isNotEmpty
                          ...
                          : 'Your department has no members yet.',
                    )
                  : _buildList(members),
            ),
          ),
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder: (context, i) =>
                _MemberCard(member: members.items[i]),
          ),
        ),
        PaginationFooter(
          currentPage: _page,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            _Avatar(name: member.fullName, photoUrl: member.photoUrl),
